...
public class TestContext {
    ...
    public InboxPage getInboxPage() {
        if (inboxPage == null) inboxPage = new InboxPage(getDriver());
        return inboxPage;
    }

    public ComposeMessagePage getComposeMessagePage() {
        if (composeMessagePage == null) composeMessagePage = new ComposeMessagePage(getDriver());
        return composeMessagePage;
    }

    public ProfilePage getProfilePage() {
        if (profilePage == null) profilePage = new ProfilePage(getDriver());
        return profilePage;
    }
}
